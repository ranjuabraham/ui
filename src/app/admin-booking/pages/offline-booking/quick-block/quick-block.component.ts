...
import {MapViewDialogComponent} from "../../../../users/pages/halls-list/map-view-dialog/map-view-dialog.component";
import {ReviewsDialogComponent} from "../../../../users/pages/halls-list/reviews-dialog/reviews-dialog.component";

@Component({
  selector: 'app-quick-block',
  templateUrl: './quick-block.component.html',
  styleUrls: ['./quick-block.component.scss']
})
export class QuickBlockComponent implements OnInit, AfterViewInit {
