...
@Component({
  selector: 'app-buffet-category-update',
  templateUrl: './buffet-category-update.component.html',
  styleUrls: ['./buffet-category-update.component.scss']
})
export class BuffetCategoryUpdateComponent implements OnInit {
  ...
  constructor(private buffetMasterService: BuffetCategoryService,
