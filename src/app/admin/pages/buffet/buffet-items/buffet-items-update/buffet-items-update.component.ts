...
@Component({
  selector: 'app-buffet-items-update',
  templateUrl: './buffet-items-update.component.html',
  styleUrls: ['./buffet-items-update.component.scss']
})
export class BuffetItemsUpdateComponent implements OnInit {
  ...
  $masterId  = this.route.snapshot.params['masterId'];
  ...
  constructor(private buffetItemsService: BuffetItemsService,
    ...
    private notificationService: NotificationService
      ...
      this.buffetForm = fb.group({
        ...
        'action': ['update'],
        'usrId': [this.userId],
        'fdMenuId': [null, Validators.required],
  ...
  loadBuffetById(){
    this.buffetItemsService.loadItemById(this.$prdctDetId, this.$masterId, this.$attrId)
    .subscribe(result => {
