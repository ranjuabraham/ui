...
@Component({
  selector: 'app-duration-create',
  templateUrl: './duration-create.component.html',
  styleUrls: ['./duration-create.component.scss']
})
export class DurationCreateComponent implements OnInit {
  ...
  constructor(private durationService: DurationService,
    ...
    loadEvents(){
      this.durationService.loadEvents(this.prdctDetId)
      .subscribe(result => { this.restItems = result;
        this.events = this.restItems.result; });
    }
