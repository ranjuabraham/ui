...
@Component({
  selector: 'app-pax-count-create',
  templateUrl: './pax-count-create.component.html',
  styleUrls: ['./pax-count-create.component.scss']
})
export class PaxCountCreateComponent implements OnInit {
  ...
  ngOnInit() {
    this.paxCountService.loadMasters(this.prdctDetId)
