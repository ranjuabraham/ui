...
@Component({
  selector: 'app-online-transaction-booking',
  templateUrl: './online-transaction-booking.component.html',
  styleUrls: ['./online-transaction-booking.component.scss']
})
export class OnlineTransactionBookingComponent implements OnInit {
  ...
  constructor(
    ...
    updateTransaction(prdctDetId: string, usrId: string, txnId: string, status: string) {
      ...
      goBack() {
        this.transactionService.loadTransactions(this.prdctDetId, 1, this.userId, this.userTypeId);
      }
