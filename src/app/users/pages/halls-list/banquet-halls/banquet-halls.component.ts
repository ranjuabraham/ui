...
export class BanquetHallsComponent implements OnInit {
  ...
  public checkedCategory = this.appService.banquetHallId;
  ...
  constructor(public fb: FormBuilder, private activatedRoute: ActivatedRoute, public appService: AppService,
    ...
    this.categoryId = this.appService.banquetHallId;
    ...
    this.selectedCategory = this.appService.banquetHallId;
    if (this.loginData) {
  ...
  ngOnInit() {
    this.selectedCategory = this.appService.banquetHallId;  // categoryId = 7;
  ...
  removePriceFilter(): void {
    ...
    this.router.navigate(['/chennai/banquet-halls'],
      {
        queryParams: {
          prdctId: this.appService.banquetHallId, capacityId: this.categoryId,
  ...
  removeCapacityFilter(): void {
    ...
    this.router.navigate(['/chennai/banquet-halls'],
      {
        queryParams: {
          prdctId: this.appService.banquetHallId, capacityId: this.capacityId,
...
// convenience getter for easy access to form fields
  ...
  getHallFilter() {
    this.appService.getHallFilter(this.appService.banquetHallId, this.capacityId, this.priceRangeId, this.areaId)
      .subscribe(data => {
        this.hallsData = data;
  ...
  public getHallsList() {
    ...
    // this.loading = false;
    this.appService.getHallsList(this.appService.banquetHallId.toString(), '0', this.capacityId, this.priceRangeId,
  ...
  editsearch() {
    const editsearchDialog = this.dialog.open(EditSearchComponent, {
      ...
      data: {categoryId: this.appService.banquetHallId}
    })
  }
