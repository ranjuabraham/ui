...
import {CheckAvailabilityComponent} from "../../../../admin/pages/booking-management/check-availability/check-availability.component";
...
export class MarriageHallsComponent implements OnInit {
  @Output() change: EventEmitter<MatRadioChange>;
  @Input() name: string;
  @Input() ariaLabel: string;
  @ViewChild('sidenav') sidenav: any;
  public sidenavOpen: boolean = true;
  public totalRecord: boolean = true;
  ...
  public checkedCategory = this.appService.marriageHallId;
  ...
  constructor(public fb: FormBuilder, private activatedRoute: ActivatedRoute, public appService: AppService,
    ...
    this.categoryId = this.appService.marriageHallId;
    ...
    this.selectedCategory = this.appService.marriageHallId;
    if (this.loginData) {
  ...
  ngOnInit() {
    this.selectedCategory = this.appService.marriageHallId;  // categoryId = 4;
  ...
  removePriceFilter(): void {
    ...
    this.router.navigate(['/chennai/marriage-halls'],
      {
        queryParams: {
          prdctId: this.appService.marriageHallId, capacityId: this.categoryId,
  ...
  removeCapacityFilter(): void {
    ...
    this.router.navigate(['/chennai/marriage-halls'],
      {
        queryParams: {
          prdctId: this.appService.marriageHallId, capacityId: this.capacityId,
...
// convenience getter for easy access to form fields
  ...
  getHallFilter() {
    this.appService.getHallFilter(this.appService.marriageHallId, this.capacityId, this.priceRangeId, this.areaId)
      .subscribe(data => {
        this.hallsData = data;
  ...
  public getHallsList() {
    ...
    // this.loading = false;
    this.appService.getHallsList(this.appService.marriageHallId.toString(), '0', this.capacityId, this.priceRangeId,
  ...
  editsearch() {
    const editsearchDialog = this.dialog.open(EditSearchComponent, {
      ...
      data: {categoryId: this.appService.marriageHallId}
    })
  }
