import {Component, OnInit, OnDestroy, ViewChild, HostListener, EventEmitter, Output, Input, forwardRef} from '@angular/core';
...
export class PartyHallsComponent implements OnInit {
  ...
  public checkedCategory = this.appService.partyHallId;
  ...
  constructor(public fb: FormBuilder, private activatedRoute: ActivatedRoute, public appService: AppService,
    ...
    this.categoryId = this.appService.partyHallId;
    ...
    this.selectedCategory = this.appService.partyHallId;
    if (this.loginData) {
  ...
  ngOnInit() {
    this.selectedCategory = this.appService.partyHallId;  // categoryId = 2;
  ...
  removePriceFilter(): void {
    ...
    this.router.navigate(['/chennai/party-halls'],
      {
        queryParams: {
          prdctId: this.appService.partyHallId, capacityId: this.categoryId,
  ...
  removeCapacityFilter(): void {
    ...
    this.router.navigate(['/chennai/party-halls'],
      {
        queryParams: {
          prdctId: this.appService.partyHallId, capacityId: this.capacityId,
...
// convenience getter for easy access to form fields
  ...
  getHallFilter() {
    this.appService.getHallFilter(this.appService.partyHallId, this.capacityId, this.priceRangeId, this.areaId)
      .subscribe(data => {
        this.hallsData = data;
  ...
  public getHallsList() {
    ...
    // this.loading = false;
    this.appService.getHallsList(this.appService.partyHallId.toString(), '0', this.capacityId, this.priceRangeId,
  ...
  editsearch() {
    const editsearchDialog = this.dialog.open(EditSearchComponent, {
      ...
      data: {categoryId: this.appService.partyHallId}
    })
  }
